...
export default function StoreFooter() {
  return (
    <footer className="bg-[#061728] text-[#c9d7e1]" dir="rtl">
      <div className="mx-auto max-w-7xl px-5 py-12 sm:py-16">
        <div className="grid gap-10 md:grid-cols-[1.15fr_.85fr_.85fr]">
          <div>
            ...
            <div className="mt-6 inline-flex items-center gap-2 rounded-xl border border-[#80e1d5]/20 bg-white/[.04] px-4 py-3 text-xs font-bold text-[#80e1d5]">
          ...
          <div>
            ...
            <div className="mt-5 space-y-4 text-sm leading-7">
              <p className="flex items-start gap-3">
                <span className="mt-1 grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-[#80e1d5]/10 text-[#80e1d5]">
