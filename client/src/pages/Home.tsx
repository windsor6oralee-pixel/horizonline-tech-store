...
export default function Home() {
  ...
  return <div className="min-h-screen bg-[#f6f9fc] pb-[86px] md:pb-0" dir="rtl">
    ...
    <main id="top">
      ...
      <div className="mt-8"><p className="flex items-center gap-2 text-sm font-extrabold text-[#0a2342]"><Info className="h-4 w-4 text-[#1f6f96]" />استلام موثّق: ما يحدث عند وصول المندوب</p><div className="mt-4"><DeliveryRulesBento /></div></div></div></section>
